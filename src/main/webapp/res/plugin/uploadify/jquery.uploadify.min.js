...
SWFUpload.prototype.initSettings = function() {
	...
	if (!this.settings.preserve_relative_urls) {
		...
		if (this.settings.button_image_url1 = "")
...
(function(c) {
			...
			this
					.each(function() {
						...
						if (e[0]) {
							...
							$item.delay(200).fadeOut(300, function() {
								c(this).remove();
							});
						}
					});
	...
	var a = {
		onDialogOpen : function() {
			var d = this.settings;
			this.queueData.errorMsg = "一些文件不能被添加到上传队列:";
