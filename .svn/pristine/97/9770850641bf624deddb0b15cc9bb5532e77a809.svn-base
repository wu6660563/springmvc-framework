    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var init = function(update) {
            ...
            var html = '' +
                ...
                '<tr>' +
                '<td class="dp_previous"><a href="javascript:;" class="ic-left-open"></a>' + '</td>' +
                // plugin.settings.header_navigation[0] + '</td>' +
                '<td class="dp_caption">&#032;</td>' +
                '<td class="dp_next"><a href="javascript:;" class="ic-right-open"></a>' + '</td>' +
                // plugin.settings.header_navigation[1] + '</td>' +
                '</tr>' +
                '</table>' +
        ...
        var disable_text_select = function(el) {
            ...
            else if (browser.name == 'explorer') el.bind('selectstart', function() {
                return false;
            });
